...
def decisionTree(df_list):
    ...
    # prediction_Dat = dt.predict(test_array_Dat)
    # print("Dat's file: ", prediction_Dat)
    # prediction_Duc = dt.predict(test_array_Duc)
    # print("Duc's file: ",prediction_Duc)

    y_pred = dt.predict(X_test)

    cal_accuracy(y_test, y_pred)

    # createDecisionTreeGraph(dt, labels)
